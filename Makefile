...
BICSRCS := main bicycle Config c/Activity c/SshInput v/ColorPalette v/Window c/WindowManager m/Personality # m/Body c/Input v/Bar m/Blackboard v/Dialogue c/Dice v/Menu c/MidiPlayer v/Graph v/Grid c/Timer 
