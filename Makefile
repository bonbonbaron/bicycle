...
BICSRCS := main bicycle Config c/Trigger c/Timer c/SshInput v/ColorPalette v/Window c/WindowManager m/Blackboard # m/Body c/Input v/Bar v/Dialogue c/Dice v/Menu c/MidiPlayer v/Graph v/Grid 
