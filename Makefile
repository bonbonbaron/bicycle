...
BICSRCS := main bicycle Config c/Activity c/SshInput v/ColorPalette v/Window c/WindowManager m/Personality m/Blackboard # m/Body c/Input v/Bar v/Dialogue c/Dice v/Menu c/MidiPlayer v/Graph v/Grid c/Timer 
